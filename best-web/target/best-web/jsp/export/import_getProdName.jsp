...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="/import/lookup/list_prod_name.html" method="post">
    ...
    <table data-toggle="tablefixed" data-width="100%">
        ...
        <c:forEach items="${products}" var="product" varStatus="i" >
               ...
               <td><c:out value="${product.nums}"></c:out></td>
                <td>
                    <a href="javascript:;" data-toggle="lookupback" data-args="{importProdId:'${product.prodNo }',importName:'${product.prodName }',importType:'${product.prodType }',importSize:'${product.prodSize }',nums:'${product.nums }'}" class="btn btn-blue" title="選擇本項" data-icon="check">選擇</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
